...
public class EliminarCuenta extends javax.swing.JPanel {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        String numero = labelNCuenta.getText().trim();
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
                "¿Seguro que desea eliminar la cuenta " + numero + "?\nSe perderá todo el historial.", 
        ...
        String resultado = banco.eliminarCuenta(numero);

        if (resultado.equals("OK")) {
            JOptionPane.showMessageDialog(this, "Cuenta eliminada correctamente.");
            labelNCuenta.setText("");
        } else {
            JOptionPane.showMessageDialog(this, resultado, "No se pudo eliminar", JOptionPane.ERROR_MESSAGE);
        }
